...
def context(browser,timeout=False):
 ...
 page.goto(BASE+'/',wait_until='networkidle');page.locator('summary').click();page.locator('#voiceEngine').select_option('native');page.locator('#consent').check();page.locator('#speak').check()
