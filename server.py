...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        paths={'/':('index.html','text/html; charset=utf-8'),'/app.mjs':('app.mjs','text/javascript'),'/voice-audit.mjs':('voice-audit.mjs','text/javascript'),'/core.mjs':('core.mjs','text/javascript'),'/capture-gate.mjs':('capture-gate.mjs','text/javascript'),'/voice-runtime.mjs':('voice-runtime.mjs','text/javascript'),'/audio-worklet.js':('audio-worklet.js','text/javascript'),'/style.css':('style.css','text/css'),'/readback.mjs':('readback.mjs','text/javascript'),'/streaming-request.mjs':('streaming-request.mjs','text/javascript')}
