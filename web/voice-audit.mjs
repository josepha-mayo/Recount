...
const EVENTS=new Set(['speaker_test_started','speaker_test_finished','speaker_test_confirmed','speaker_test_unheard','speaker_test_failed','readback_failed','capture_options','session_requested','provider_begin','provider_final','duplicate_final_ignored','readback_started','readback_finished','readback_cancelled','readback_superseded','premature_confirmation_rejected','session_hold','session_closed','stop_requested','consent_revoked']);
