...
export class VoiceAudit {
  ...
  snapshot(state,{origin='',assetHashes={}}={}){
    ...
    return {
      ...
      privacy:{audio_recorded:false,audio_in_report:false,credentials_in_report:false,contains_transcript_text:true,upload_performed:false},
      ...
      ledger:structuredClone({schema:'recount-session-2',revision:state.revision,counts:state.counts,pending:state.pending,review:state.review,hold:state.hold,history:state.history})
    };
  }
}
